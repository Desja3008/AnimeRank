...
function card(a){const position=sorted().findIndex(x=>x.id===a.id)+1;return `<article class="anime-card" onclick="openAnime(${a.id})"><span class="rank-badge">#${position}</span><img class="cover" src="${cover(a.cover,a.title)}" onerror="this.src='https://placehold.co/500x750/171824/ffffff?text=Anime'"><div class="card-body"><div class="title">${esc(a.title)}</div><div class="score">⭐ ${avg(a).toFixed(2)} / 6 <span>· ${a.votes.length}</span></div></div></article>`}
